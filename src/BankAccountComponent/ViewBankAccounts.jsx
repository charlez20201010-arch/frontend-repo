...
const ViewBankAccounts = () => {
  ...
  const retrieveAllAccounts = async () => {
    const response = await axios.get(
      "https://bankapi.onyemsbhospitals.org /api/bank/account/fetch/bankwise?bankId=" +
        bank.bank.id,
      {
        headers: {
  ...
  const retrieveAllAccountsByBankAccount = async () => {
    const response = await axios.get(
      "https://bankapi.onyemsbhospitals.org /api/bank/account/search?bankId=" +
        bank.bank.id +
        "&accountNumber=" +
        accountNumber,
      {
  ...
  const openAccount = (accountId, e) => {
    ...
    fetch("https://bankapi.onyemsbhospitals.org /api/bank/account/update/status", {
      method: "POST",
      headers: {
